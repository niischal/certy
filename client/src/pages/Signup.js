          ...
          <div className="row justify-content-center">
            <form className="col-lg-6">
              <div className="form-group my-3">
                ...
                <input type="text" className="form-control" placeholder="NIST College" />
              </div>
              ...
              <div className="form-group d-flex my-3">
                ...
                <div className="col-6 pl-2">
                  ...
                  <input type="tel" className="form-control" placeholder="0119432" />
                </div>
              </div>
              
              <div className="form-group my-3">
                <label>Email</label>
                <input type="email" className="form-control" placeholder="info@nist.edu.np" />
              </div>
              <div className="form-group d-flex my-3">
                <div className="col-6 pr-2">
              ...
              <div className="text-center my-3">
                <button type="button" className="btn btn-outline-info">Request</button>
              </div>
              <hr />
              <div className="text-center my-3">
                <Link to="/">
